    ...
    <>
      <Container sx={{paddingBottom:"40px"}}>
        <div className="h-fit pb-[100px] pt-[100px]">
          <div
          className="h-[65%] pb-[40px] flex flex-col md:flex-row gap-10 items-center justify-between"
          >
          ...
          <Link
            href={{
              ...
              query: { user: JSON.stringify(user) }, // Replace 'user' with your actual user object
            }}
